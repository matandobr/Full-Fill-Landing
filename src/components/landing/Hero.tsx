      ...
      <div className="flex w-full max-w-[1400px] items-center gap-10 md:gap-20 max-md:flex-col">
        <div className="flex w-full flex-col justify-center flex-1 max-w-[700px] min-w-[560px] max-md:min-w-0 max-md:max-w-full">
          <div className="w-full text-[#151357]">
            <h1 className="text-[#151357] text-[44px] font-bold leading-[62px] mt-4 max-md:max-w-full max-md:text-[34px] max-md:leading-[40px]">
            Questionnaires, RFPs, and RFIs, <span className="text-[#5E5ADB] ">AI-Powered Answers</span>
            </h1>
          </div>
          <p className="text-[#222834] text-xl font-normal leading-7 mt-10 max-md:max-w-full max-md:text-lg">
          Full-Fill automates customer Questionnaires, RFPs, and RFIs using <b>AI-generated</b> answers from your <b>existing content.</b><br/>
          <br/>
          Save up to 80% of your response time - starting today.
          </p>
        ...
        <div className="flex-shrink-0 max-md:w-full max-md:mt-8">
          <img 
            ...
            alt="Full-Fill AI questionnaire interface showing Questionnaire response automation and document analysis capabilities for sales engineers and presales teams"
